...
public class MocapMarker
{
   ...
   public MocapMarker(int id,
                      int rigidBodyId,
                      Vector3D position,
                      float markerSize,
                      boolean markerIsOccludedInThisFrame,
                      boolean positionSolvedFromPointCloud,
                      boolean positionSolvedFromModel,
                      boolean markerIsAssociated,
                      boolean markerIsUnLabeledWithId,
                      boolean markerHasActiveLEDMarker,
                      float residualError)
   {
      this.labeled = true;
      this.markerId = id;
